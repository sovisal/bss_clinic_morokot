	...
	<table class="table-header" width="100%">
		<tr>
			...
			<td class="text-center">
				<h2 class="KHMOULLIGHT text-blue">មន្ទីរសម្រាកព្យាបាល និង សម្ភព  មរកត</h2>
				<h1 class="text-bold text-blue">MOROKOT CLINIC & MATERNITY</h1>
				<div>សង្រ្គោះបន្ទាន់ ២៤ម៉ោង  ឯកទេសវះកាត់ ឆ្អឹងបាក់បាក់បែក</div>
				<div>សម្ភព រោគស្ត្រី វិទ្យុសាស្ត្រ អេកូ XRay CT ស្កេន មន្ទីរពិសោធន៍</div>
			</td>
		</tr>
	</table>
