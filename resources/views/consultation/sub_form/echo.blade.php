<form action="{{ route('para_clinic.echography.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
    ...
    <x-modal id="treatment_modal_echo" dialogClass="modal-full" data-backdrop="static" data-keyboard="false" header="Create new Echography">
        <table class="table-form table-padding-sm striped">
            <tr>
                ...
                <td>
                    <div class="d-flex">
                        <x-bss-form.select name="type" required id="echo_type">
